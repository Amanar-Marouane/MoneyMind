        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-6">
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col gap-4">
                    <h3 class="text-lg font-medium pb-4">{{ __('Monthly Overview:') }}</h3>

                    <div class="flex justify-center gap-4">
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow w-full">
                            <h4
                                class="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide mb-2">
                                {{ __('Current Budget') }}
                            </h4>
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400">
                                {{ $user->budget }} DH</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                {{ 'Try Consulting Our AI Assistants For More Management Accuracy' }}</p>
                        </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow w-full">
                            ...
                            <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $user->total_expenses() }}
                                DH</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('this month so far') }}</p>
                        </div>
                    </div>

                    <div class="mt-8 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ $daysLeft . ' days remaining this month' }}</p>
                    </div>
                </div>
            </div>
            ...
            @if ($categoryExpense)
                <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex justify-center items-center flex-col md:flex-row gap-6 min-w-full">
                            <div class="md:w-1/2">
                ...
                <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg">
                            <div
                                class="max-h-[calc(3*4.5rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
                ...
                <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div
                            class="max-h-[calc(3*5.5rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
                            <div class="space-y-4 pr-2">
                                @foreach ($recExpenses as $expense)
                                            ...
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                    ...
                                                    {{ Carbon::parse($expense->starting_date)->greaterThan(now())
                                                        ? Carbon::parse($expense->starting_date)->format('Y-m-d')
                                                        : Carbon::parse($expense->starting_date)->addMonth()->format('Y-m-d') }}
                                                </div>
                                            </div>
